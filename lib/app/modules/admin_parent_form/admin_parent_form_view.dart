...
class AdminParentFormView extends GetView<AdminParentFormController> {
  const AdminParentFormView({super.key});
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Column(
                            children: [
                              Obx(() {
                                ...
                                final photoUrl =
                                    controller.existingParent?.photoUrl;
                        ...
                        const SizedBox(height: 24),
                        TextFormField(
                          controller: controller.studentNisnController,
                          decoration: InputDecoration(
                            labelText: 'NISN Anak *',
                            hintText: 'Masukkan NISN anak',
                          ...
                          validator: (value) {
                            if (value == null || value.trim().isEmpty) {
                              return 'NISN anak tidak boleh kosong';
                            }
                            return null;
                          },
                        ),
                        ...
                        TextFormField(
                          ...
                          obscureText: true,
                          validator: (value) {
                            if (controller.existingParent == null) {
                              if (value == null || value.trim().isEmpty) {
