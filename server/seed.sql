...
-- Insert Admin
INSERT INTO admins (nik, name, email, phone, password_hash) VALUES
('1234567890123456', 'Admin Sekolah', 'admin@raudha.sch.id', '081234567890', 'admin123'),
('1234567890123457', 'Admin Sistem', 'admin2@raudha.sch.id', '081234567891', 'admin123');
...
('Kelas 1A', 1, 2, '2025/2026'),
('Kelas 1B', 1, 3, '2025/2026'),
('Kelas 2A', 2, 4, '2025/2026'),
('Kelas 2B', 2, 2, '2025/2026'),
('Kelas 3A', 3, 3, '2025/2026');
...
('Rapat Wali Murid Kelas 1', 'Diberitahukan kepada seluruh wali murid kelas 1 bahwa akan diadakan rapat pada hari Sabtu, 14 Desember 2025 pukul 09:00 WIB di Aula Sekolah. Kehadiran sangat diharapkan. Terima kasih.', 1, 'admin', 'parents'),
('Informasi Kegiatan Outing Class', 'Anak-anak kelas 2 akan mengikuti kegiatan outing class ke Taman Mini Indonesia Indah pada hari Rabu, 18 Desember 2025. Mohon mempersiapkan bekal dan pakaian ganti. Biaya partisipasi sebesar Rp 50.000.', 2, 'guru', 'parents'),
('Libur Semester Ganjil', 'Kegiatan belajar mengajar semester ganjil akan berakhir pada tanggal 20 Desember 2025. Libur semester akan dimulai tanggal 23 Desember 2025 sampai dengan 5 Januari 2026. Pembelajaran semester genap dimulai 6 Januari 2026.', 1, 'admin', 'all'),
('Pengumuman Ujian Akhir Semester', 'Ujian Akhir Semester akan dilaksanakan pada tanggal 16-19 Desember 2025. Mohon siswa mempersiapkan diri dengan baik. Jadwal lengkap akan dibagikan melalui wali kelas masing-masing.', 1, 'guru', 'all');

-- Insert Sample Attendance (beberapa hari terakhir)
INSERT INTO attendance (student_id, date, status, check_in, scanned_by) VALUES
-- 11 Desember 2025
(1, '2025-12-11', 'hadir', '07:15:00', 2),
(2, '2025-12-11', 'hadir', '07:20:00', 2),
(3, '2025-12-11', 'hadir', '07:18:00', 2),
(4, '2025-12-11', 'hadir', '07:25:00', 3),
(5, '2025-12-11', 'sakit', NULL, NULL),
-- 12 Desember 2025
(1, '2025-12-12', 'hadir', '07:10:00', 2),
(2, '2025-12-12', 'hadir', '07:22:00', 2),
(3, '2025-12-12', 'izin', NULL, NULL),
(4, '2025-12-12', 'hadir', '07:30:00', 3),
(5, '2025-12-12', 'hadir', '07:28:00', 3),
-- 13 Desember 2025 (hari ini)
(1, '2025-12-13', 'hadir', '07:12:00', 2),
(2, '2025-12-13', 'hadir', '07:19:00', 2);
...
UPDATE leave_requests SET reviewed_by = 2, reviewed_at = '2025-12-11 07:00:00', review_notes = 'Disetujui. Semoga lekas sembuh.' WHERE id = 1;
UPDATE leave_requests SET reviewed_by = 2, reviewed_at = '2025-12-12 07:05:00', review_notes = 'Disetujui.' WHERE id = 2;
